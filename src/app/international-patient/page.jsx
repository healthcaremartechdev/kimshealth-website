                                        ...
                                        <div className="hospital-banner-container">
                                            ...
                                            <div className="details-banner">
                                                <div className="details-heading">
                                                    ...
                                                    <a href={basePath + "/plan-your-visit"} class="form-btn w-auto px-5 me-3">Plan Your Visit</a>
                                                    <a href={basePath + "/get-an-estimate"} class="form-btn w-auto px-5">Get An Estimate</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
